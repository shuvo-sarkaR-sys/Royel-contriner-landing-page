...
const HeroSection = () => {
  return (
    <div  className='relative'>
        ...
        <h1 className='md:text-7xl text-4xl font-oswald text-white  font-extrabold'>NEED A CONTAINER? <span className='text-[#BCA468]'>BUY <br /> OR RENT</span>-- {"WE'VE"} GOT YOU <br/> COVERED.</h1>
